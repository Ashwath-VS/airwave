...
const api = axios.create({
  ...
  timeout: 900_000,  // exhaustive mode (5 rounds × 8 agents) can take up to 15 minutes
})
...
export const fetchRouteNews = (origin, dest) => api.get('/api/airwave/news', { params: { origin, destination: dest } }).then(r => r.data)
